      ...
      <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
          <form role="form" action="<?php echo e(URL::to('/insert_triplep24')); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="pull-right">
            <a class="btn btn-primary" href="<?php echo e(route('triplep24.index')); ?>"> Back</a>
        </div>
    </div>
</div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/backend/triplep24/create_triplep24.blade.php ENDPATH**/ ?>